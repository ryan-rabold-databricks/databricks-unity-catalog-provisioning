...
To add a new schema to the test environment:

1. Create a JSON file in `../../schemas/test/`:

```bash
cat > ../../schemas/test/my-new-schema.json << 'EOF'
{
  "schema_name": "my_new_schema",
  "schema_comment": "My new schema for testing",
  "schema_properties": {
    "environment": "test",
    "team": "my_team",
