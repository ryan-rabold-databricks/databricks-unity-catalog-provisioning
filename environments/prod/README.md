...
This directory contains the Terraform configuration for the **test** environment.
...
To add a new schema to the production environment:

1. Create a JSON file in `../../schemas/prod/`:

```bash
cat > ../../schemas/prod/my-new-schema.json << 'EOF'
{
  "schema_name": "my_new_schema",
  "schema_comment": "My new schema for production",
  "schema_properties": {
    "environment": "test",
    "team": "my_team",
